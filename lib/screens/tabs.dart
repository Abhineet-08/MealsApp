...
class _TabsScreen extends State<TabsScreen> {
  ...
  void _toggleMealFavouriteStatus(Meal meal) {
    final isExisting = _favouritesMeal.contains(meal);
    if (isExisting) {
      setState(() {
        _favouritesMeal.remove(meal);
        _showInfoMessage('Removed as favourite');
      });
    } else {
      setState(() {
        _favouritesMeal.add(meal);
